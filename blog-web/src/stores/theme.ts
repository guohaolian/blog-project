...
export const useThemeStore = defineStore('theme', {
  state: () => ({
    // Default is auto (schedule). If user explicitly chose light/dark before, use it.
  ...
  actions: {
    setMode(mode: ThemeMode) {
      ...
      // Only manual override should persist.
    ...
    init() {
      // Hydrate stored manual override at startup.
